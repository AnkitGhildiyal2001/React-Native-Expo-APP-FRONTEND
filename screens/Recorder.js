...
const YOUR_SERVER_URL = "http://192.168.29.246/EXPO/iswitch-hr-server/public/";
...
const Recorder = ({ navigation }) => {
    ...
    const { hasPermission, cameraType, isFlashLightOn, videoStatus, ShowLoader, ShowPopup } = values;
